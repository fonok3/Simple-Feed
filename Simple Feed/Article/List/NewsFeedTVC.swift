...
enum RefreshStatus { case nothing, refreshSingleFeed, refreshAll }
...
class NewsFeedTVC: UITableViewController, NSFetchedResultsControllerDelegate, UIViewControllerPreviewingDelegate, ShareDelegate {
    // - Mark: Attributes
